 ...
 */
public class EngineeringForeign extends ForeignStudent {
    /**
     ...
     */
    public EngineeringForeign(String firstName, String lastName, String studentID, int numberOfRegisteredHours, StudentStatus studentStatus) {
     ...
     */
    public EngineeringForeign(String firstName, String lastName, String studentID, int numberOfRegisteredHours, String studentStatus) {
        super(firstName, lastName, studentID, numberOfRegisteredHours, studentStatus);
    }
