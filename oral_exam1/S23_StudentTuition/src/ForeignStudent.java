...
public class ForeignStudent extends Student {
     ...
     */
    public ForeignStudent(String firstName, String lastName, String studentID, int numberOfRegisteredHours, StudentStatus studentStatus) {
     ...
     */
    public ForeignStudent(String firstName, String lastName, String studentID, int numberOfRegisteredHours, String studentStatus) {
        super(firstName, lastName, studentID, numberOfRegisteredHours, studentStatus);
    }
    ...
    public String toString() {
        return super.toString()+", Place of Residence: " + "Foreign";
    }
